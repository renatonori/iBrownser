//
//  DispositivosTabBarViewController.swift
//  iBrowser
//
...
class DispositivosTabBarViewController: UITabBarController,UITabBarControllerDelegate {
    
    var infoDispositivo:dispositivo?
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        self.navigationItem.backBarButtonItem?.title = "teste"
    }
